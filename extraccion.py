...
filtro4=df1.loc[['2022-11-22','2022-12-22'], ['SUBTOTAL_PARTIDA']]  
print(filtro4)
...
filtro8=df[(df['SUBTOTAL_PARTIDA']>77000) | (df['FECHA_DOC']=='2022-03-31')]
print(filtro8)
filtro8.to_csv("Entregable8.csv")

filtro9=df[~(df['SUBTOTAL_PARTIDA'] > 77000) & ~(df['FECHA_DOC']=='2022-01-05')] 
print(filtro9)
